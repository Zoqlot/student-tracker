...
import { LayoutDashboard, BookOpen, Users, Settings, Languages, LogOut } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-slate-950 text-slate-300 min-h-screen p-4 flex flex-col border-e border-slate-800 shrink-0">
      <div className="flex items-center gap-2 mb-8 px-2 text-white">
        <LayoutDashboard className="h-6 w-6 text-blue-500" />
        <span className="text-xl font-bold">{t('portalTitle')}</span>
      </div>
